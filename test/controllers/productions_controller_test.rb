...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { link: @production.link, order: @production.order, realisation: @production.realisation, title: @production.title, year: @production.year }
    end
  ...
  test "should update production" do
    patch :update, id: @production, production: { link: @production.link, order: @production.order, realisation: @production.realisation, title: @production.title, year: @production.year }
    assert_redirected_to production_path(assigns(:production))
  end
