...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { email: @datum.email, link: @datum.link, order: @datum.order, phone: @datum.phone, ref: @datum.ref, year: @datum.year }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { email: @datum.email, link: @datum.link, order: @datum.order, phone: @datum.phone, ref: @datum.ref, year: @datum.year }
    assert_redirected_to datum_path(assigns(:datum))
  end
